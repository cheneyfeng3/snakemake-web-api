...
class Executor(RemoteExecutor):
    ...
    def run_job(self, job: JobExecutorInterface):
        ...
        exec_job = f"python -m snakemake --snakefile '{self.workflow.main_snakefile}' --cores 1 --forceall --nocolor --use-conda --conda-prefix '../.snakemake/conda' --wrapper-prefix '../repos/snakemake-wrappers/'"
        ...
        # ]
        container.working_dir = self.workflow.storage_settings.default_storage_prefix
        container.volume_mounts = []
